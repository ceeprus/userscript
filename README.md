...
| [VRChat: Hide Worlds](https://raw.githubusercontent.com/ceeprus/userscript/main/vrchat/vrchat-hide-worlds.user.js) | Hides worlds you never want to see again from the VRChat website. Marks hidden worlds with a badge next to the name and turns the world page's Launch button red, with an eye toggle button next to the friends list. |
